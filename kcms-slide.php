...
// RevSlider Activatior----------------------------------
update_option( 'revslider-valid', 'true' );
update_option( 'revslider-code', '11111111-1111-1111-1111-111111111111' );
...
define('RS_TP_TOOLS',			'6.5.10'); //holds the version of the tp-tools script, load only the latest!
